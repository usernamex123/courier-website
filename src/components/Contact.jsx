export default function Contact() {
  return (
    <section id="contact-us" className="w-full bg-[#1c1917] text-white py-16 px-6 md:px-24 font-sans">
          ...
          <div className="space-y-6">
            ...
            <form className="space-y-4">
              <input 
                ...
                className="w-full p-3.5 bg-transparent border-2 border-white/20 text-white placeholder-white/50 outline-none focus:border-yellow-500 transition-colors duration-300 font-semibold text-sm md:text-base" 
              />
              
              <button 
                type="submit"
                className="w-full bg-transparent text-white font-bold py-4 uppercase tracking-widest border-2 border-white transition-all duration-300 ease-in-out hover:bg-yellow-500 hover:text-black hover:border-yellow-500 shadow-lg cursor-pointer text-sm md:text-base"
              >
                Send
              </button>
            </form>
